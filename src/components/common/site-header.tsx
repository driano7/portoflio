...
import { Blocks, FolderGit2, Home, Menu, UserRound } from "lucide-react";
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            >
              <div className="flex h-full flex-col px-4 pt-16">
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          "flex flex-col items-center justify-center gap-2 rounded-2xl border px-4 py-5 transition-colors",
                          active
